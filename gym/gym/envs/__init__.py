...
register(
    id='CartPole-v2',
    entry_point='gym.envs.classic_control.cartpole_stoc:CartPoleEnv',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='Reacher-v3',
    entry_point='gym.envs.mujoco.reacher_stoc:ReacherEnv',
    max_episode_steps=50,
    reward_threshold=-3.75,
)
...
register(
    id='Hopper-v4',
    entry_point='gym.envs.mujoco.hopper_ilfo:HopperEnv',
...
register(
    id='Hopper-v5',
    entry_point='gym.envs.mujoco.hopper_v5:HopperEnv',
    max_episode_steps=400,
    reward_threshold=3800.0,
)
...
#register(
#    id='Hopper-v6',
#    entry_point='gym.envs.mujoco.hopper_v6:HopperEnv',
#    max_episode_steps=400,
#    reward_threshold=3800.0,
#)
...
register(
    id='Hopper-v7',
    entry_point='gym.envs.mujoco.hopper_stoc:HopperEnv',
    max_episode_steps=400,
    reward_threshold=3800.0,
)
...
register(
    id='Swimmer-v4',
    entry_point='gym.envs.mujoco.swimmer_ilfo:SwimmerEnv',
    max_episode_steps=400,
    reward_threshold=360.0,
)
...
#    id='Walker2d-v4',
#    max_episode_steps=400,
#    entry_point='gym.envs.mujoco.walker2d:Walker2dEnv',
#)
